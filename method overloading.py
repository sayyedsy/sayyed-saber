class bank:
    main_balance=500000
    def deposit(self,account_number=None,accouunt_type=None,cash_deposite=None,chek_number=None,chek_amount=None,dd_number=None,dd_amount=None):
...
b1=bank()
b1.deposit(account_number=1122334455,accouunt_type="saving",cash_deposite=50000)
b1.deposit(account_number=1122334455,accouunt_type="saving",chek_number=543216789,chek_amount=600)
b1.deposit(account_number=1122334455,accouunt_type="saving",dd_number=505060,dd_amount=300)
b1.deposit(account_number=1122334455,accouunt_type="saving")
